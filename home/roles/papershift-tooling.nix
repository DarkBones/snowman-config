...
let
  ...
  core = lib.optionalAttrs coreEnabled (let
    ...
    '';
  in {
    inherit coreBootstrap coreDev coreEnsureInfra corePgStop coreRedisStop
      coreRubocopFormat coreShell coreSidekiqAssignmentsDev coreSidekiqDev
      coreWebDev;
  });
in {
